...
<a href="README.md"><img src="https://img.shields.io/badge/🇪🇸_Español-en_curso-2E75B6?style=for-the-badge" /></a>
<a href="README.en.md"><img src="https://img.shields.io/badge/🇬🇧_English-switch-lightgrey?style=for-the-badge" /></a>
...
### Construyo puentes entre negocio y datos
...
duvan = {
    ...
    "rol":          "Data Engineer Jr. | Data Analyst",
    "ubicacion":    "Medellín, Colombia 🇨🇴",
    "formacion":    ["RIWI.io — Análisis e Ingeniería de Datos (2025 - Actualidad)",
                      "Soy Henry — Full Stack Developer (2021 - 2022)"],
    "idiomas":      ["Español (nativo)", "Inglés (B1)"],
    "diferencial":  "Traduzco necesidades de negocio en soluciones de datos accionables",
    "stack":        ["Python", "Apache Spark", "Apache Airflow", "Power BI", "AWS"],
}
```

Analista de Datos con formación sólida en **ingeniería de datos, Business Intelligence y automatización de flujos de información**. Construyo pipelines ETL con Python, Apache Airflow y Apache Spark, y dashboards ejecutivos en Power BI sobre infraestructura cloud (AWS).

Actúo como **socio estratégico** entre las áreas de negocio y los equipos técnicos, traduciendo necesidades reales —gestión humana, finanzas y operaciones— en soluciones analíticas accionables, priorizando iniciativas según su impacto. Combino profundidad técnica (modelos de segmentación, procesamiento de grandes volúmenes de datos) con la capacidad de comunicar hallazgos complejos a públicos no técnicos, para que los insights realmente se usen en la toma de decisiones.
...
![AI](https://img.shields.io/badge/IA_Aplicada-412991?style=for-the-badge&logo=openai&logoColor=white)
